...
use DmKravchuk\IpClock\Service\TimeProvider\TimeApiProvider;
...
class TimeApiProviderTest extends TestCase
{
    ...
    public function it_returns_server_time_dto_on_success(): void
    {
        ...
        $provider = new TimeApiProvider($httpClient, new NullLogger());
        $result = $provider->getTime($this->ip);

        $this->assertSame('timeapi.io', $result->provider);
